...
public class GoiMon extends javax.swing.JFrame {
    ...
    public GoiMon(String idBan, String tenBan) {
        idBanAn = idBan;
        tenBanAn = tenBan;
        us = new UserServices();
        ...
        List<BanHienCo> listBan= new ArrayList<>();
        int i =1;
        for (var item : us.getAllBan()) {
            BanHienCo ban = new BanHienCo();
            if(item.getIdBan().contains("B") && !item.getIdBan().equals(idBanAn))
            {
                ban.setIdBan(item.getIdBan());
                ban.setTenBan("Bàn " + i) ;
                cbBan.addItem(ban);
            }
            i++;
    ...
    private void initComponents() {
        ...
        ChuyenBan = new javax.swing.JDialog();
        ...
        ChuyenBan.setBackground(new java.awt.Color(255, 255, 255));
        ChuyenBan.setMinimumSize(new java.awt.Dimension(300, 250));
        ChuyenBan.setModal(true);

        jPanel7.setBackground(new java.awt.Color(255, 255, 255));

        jLabel1.setText("Chuyển đến");

        jLabel2.setText("Bàn hiện tại");

        lbBan.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        btXacNhan.setBackground(new java.awt.Color(51, 153, 255));
        ...
        btXacNhan.setBorderPainted(false);
        ...
        btQuayLai.setBorderPainted(false);
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addComponent(lbBan, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        .addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(cbBan, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lbBan, javax.swing.GroupLayout.Alignment.TRAILING))
        ...
        javax.swing.GroupLayout ChuyenBanLayout = new javax.swing.GroupLayout(ChuyenBan.getContentPane());
        ChuyenBan.getContentPane().setLayout(ChuyenBanLayout);
        ChuyenBanLayout.setHorizontalGroup(
            ChuyenBanLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel7, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        ChuyenBanLayout.setVerticalGroup(
            ChuyenBanLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        btChuyenban.setBackground(new java.awt.Color(0, 153, 153));
        btChuyenban.setFont(new java.awt.Font("Arial", 0, 13)); // NOI18N
        btChuyenban.setForeground(new java.awt.Color(255, 255, 255));
        btChuyenban.setText("Chuyển bàn");
        btChuyenban.setBorderPainted(false);
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btnTang, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btChuyenban, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(btnThanhToan, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 34, Short.MAX_VALUE)))))
        );
    ...
    private void btChuyenbanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btChuyenbanActionPerformed
        ...
        ChuyenBan.setLocationRelativeTo(null);
    }//GEN-LAST:event_btChuyenbanActionPerformed

    private void btXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXacNhanActionPerformed
        BanHienCo b = (BanHienCo) cbBan.getSelectedItem();
        if(us.ChuyenBan(idBanAn,b.getIdBan())) {
            JOptionPane.showMessageDialog(rootPane, "Chuyển bàn thành công", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
            dtm.setRowCount(0);
            if(dtm.getRowCount()==0) {
                us.IsOrdered_k(idBanAn);
                us.XoaDHNULL(idBanAn);
        ...
        JOptionPane.showMessageDialog(rootPane, "Chuyển bàn không thành công", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
    ...
    private javax.swing.JDialog ChuyenBan;
    ...
    private javax.swing.JComboBox<BanHienCo> cbBan;
